        ...
        <div class="row">
          <nav class="col-3 sidebar">
            ...
            <div class="sidebar-sticky">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="rating.php">
              ...
              <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="report/reportRating.php" target="_blank">
          ...
          <main class="main col">
            <nav class="navbar navbar-light">
              <span class="navbar-brand mb-0 h1">Rating</span>
