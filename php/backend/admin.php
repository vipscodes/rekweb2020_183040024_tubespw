    ...
    <div class="row">
      <nav class="col-3 sidebar">
        ...
        <div class="sidebar-sticky">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="report/reportAdmin.php" target="_blank">
      ...
      <main class="main col">
        <nav class="navbar navbar-light">
          <span class="navbar-brand mb-0 h1">Admin List</span>
          ...
          <table class="table table-sm">
            <thead>
              <tr>
                ...
                <th scope="col" class="hide">Fullname</th>
